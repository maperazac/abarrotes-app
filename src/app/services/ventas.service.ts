//  SE USABA PARA GUARDAR LAS VENTAS ACTUALES LOCALMENTE EN LOCALSTORAGE, PERO ESTO SE CAMBIO
//  Y SE EMPEZARON A GUARDAR DIRECTAMENTE EN BASE DE DATOS, POR ESO SE DEJO DE USAR ESTE SERVICIO
